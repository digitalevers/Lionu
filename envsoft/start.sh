...
./envsoft/kafka_2.12-2.6.0/bin/zookeeper-server-start.sh  -daemon ./envsoft/kafka_2.12-2.6.0/config/zookeeper.properties&
...
./envsoft/kafka_2.12-2.6.0/bin/zookeeper-server-start.sh ./envsoft/kafka_2.12-2.6.0/config/zookeeper.properties&
exit 2
fi

./envsoft/kafka_2.12-2.6.0/bin/kafka-server-start.sh -daemon ./envsoft/kafka_2.12-2.6.0/config/server.properties&
...
./envsoft/kafka_2.12-2.6.0/bin/kafka-server-start.sh ./envsoft/kafka_2.12-2.6.0/config/server.properties&
exit 3
fi
...
#./envsoft/spark-3.5.4-bin-hadoop3/sbin/start-all.sh
#提交作业
